...
class EATableColumns
{
    ...
    public static function clear_settings_data_frontend($ea_settings) {
        $white_list = array(
            ...
            'trans.and-connection',
            'trans.available-times',
            'trans.book-appointment',
            'trans.booked',
            'trans.booking-in-progress',
            'trans.booking-unavailable-desc',
            'trans.booking-unavailable-title',
            'trans.connections-expired-desc',
            'trans.connections-expired-title',
            'trans.define-active',
            'trans.end-date-error',
            'trans.error-sending-email',
            'trans.min',
            'trans.never',
            'trans.not-available',
            'trans.not-working',
            'trans.notification-sent',
            'trans.notify-administrator',
            'trans.select-date-time',
            'trans.sending-notification',
            'trans.server-error',
            'trans.setup-required-desc',
            'trans.setup-required-title',
            'trans.tomorrow-only',
            'trans.weeks',
        );
